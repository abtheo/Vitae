...
var stack = Composites.stack(20, 15, 20, 5, 0, 0, function (x, y) {
    return Bodies.circle(x, y, Common.random(0.5, 2), { friction: 0.00001, restitution: 0.5, density: 0.001, curiosity: Math.random()});
});
